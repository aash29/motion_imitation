...
ULTRA_NAME_PATTERN = re.compile(r"ultraSound\d*")
...
class go1(minitaur.Minitaur):
  ...
  def _BuildUrdfIds(self):
    ...
    self._foot_link_ids = []
    self._imu_link_ids = []
    self._camera_link_ids = []
    self._ultra_link_ids = []
    ...
    for i in range(num_joints):
      ...
      elif CAMERA_NAME_PATTERN.match(joint_name):
        self._camera_link_ids.append(joint_id)
      elif ULTRA_NAME_PATTERN.match(joint_name):
        self._ultra_link_ids.append(joint_id)        
      else:
